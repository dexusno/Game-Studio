...
Start with a player promise and the cheapest test that could disprove it. Research should shorten the route to a good playable game. A popular category, polished competitor, or high score is not proof that our version will sell.
...
1. Read the studio charter and existing opportunities. Compare player promise, audience, core loop, and meaningful mechanical differences; a new title or art theme alone does not make a new opportunity. Revisit held ideas when their stated trigger changes.
2. Scan two lanes: **timely** themes/mechanics with recent attention, and **evergreen** needs such as short satisfying puzzles, mastery, collection, exploration, or local competition. Aim for three to six plausible hooks, not a quota of fashionable topics.
3. For each hook, inspect a few close competitors and a less successful or recent comparable when available. Record what is actually sold, price/region/date, scope, visible audience response, recurring praise/friction, and what our first ten seconds would communicate. A strong incumbent is evidence of competition as well as category interest. Do not sample winners alone.
...
5. Have another agent challenge the strongest claim and the riskiest scope assumption. Verify pivotal citations. Correct the record or lower confidence; do not create review loops for cosmetic disagreements.
