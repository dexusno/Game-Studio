...
**Latest geometry clarification, 2026-09-08:** Klaus selects a shield of individual pieces that light sequentially during LMB selection, launch in the selected count, retain the remainder for defense, and either recall/dock intact or reconstruct after destruction. Model separate finished pieces, visible sockets and readable selection/reconstruction states according to the [current shield design](../../../games/dreambound/SHIELD-DESIGN.md). The whole-disc study has not achieved B. Art modules must support different procedural level layouts; a fixed showcase scene alone is insufficient. [Premium tools and Unreal library review](art-pipeline.md) includes paid candidates without authorizing purchases.
