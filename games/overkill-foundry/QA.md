...
Continue with P08 rechecks, a real full-city policy runner and the live graphical campaign shell, preserving the final content boundary. Reviews must use the actual changed build; historical checks do not certify subsequent behavior. Fun and balance remain unvalidated.
