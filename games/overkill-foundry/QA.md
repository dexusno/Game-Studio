...
**Frozen camera/scenery update:** Editor `174242` and Game `174259` build; CampaignProbe `174355`, exact 85-line parity `174534` and ArtProbe `174613` pass. Native Load/target/Fire/same-turn-return and delayed enemy cosmetics are recorded, alongside all 19 scenery bounds. [Build/input details](unreal/Tools/README.md) and [the 50-source identity](unreal/Tools/camera-scenery-checkpoint.json) preserve exact limits; finite independent review passes on 13 inspected archived frames and the recorded source/log paths. All 50 source and 45 capture identities match. This implements the owner-selected trigger but remains below the image-16/F.I.S.T. visual benchmark. New [roster source](art-source/roster_v001_README.md) is verified and inspected, with its Unreal import still pending.
