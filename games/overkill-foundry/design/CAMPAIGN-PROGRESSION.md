...
| --- | --- | --- | --- | --- |
| **Mara 1: Cinderwall** — furnaces and scrap yards | Mite pair C1-R01; solo Breach Ram R02; solo Pressure Cask R05 | Knuckle Press R08; Cable Binder R04 | Approved two mites + Breach Ram; Coil Nest R07 | C1-O01 Redline Pursuer; C1-B01 Gatebreaker Prime |
...
| **Ivo 1: Brinegate** — salt-worn harbour | Mite pair C1-R01; solo Breach Ram R02; Pressure Cask R05 | Knuckle Press R08; Coil Nest R07 | Coil Sentinel R03; Narrowband Emitter R06 + one 6-HP mite | C1-O03 Split Chassis; C1-B02 Standby Leviathan |
...
| **Ada 1: Rivetford** — residential repair works | Mite pair C1-R01; solo Pressure Cask R05; Breach Ram R02 | Coil Nest R07; Cable Binder R04 | Knuckle Press R08; Cable Binder + one 6-HP mite | C1-O02 Foil Warden; C1-B03 Fuse Cathedral |
...
| **Noor 1: Copperwake** — tidal power works | Mite pair C1-R01; solo Breach Ram R02; Pressure Cask R05 | Coil Nest R07; Knuckle Press R08 | Cable Binder R04; Coil Sentinel R03 | C1-O03 Split Chassis; C1-B02 Standby Leviathan |
...
The Mite pair uses the approved 6-HP and 7-HP bodies. These are not random HP rolls. The approved mites-plus-ram fixture keeps its exact moves, stats and worked route. Later-city opening robots are lesser than their own city's combinations, not weaker than City 1 enemies. Their printed HP/damage remain provisional until tested against actual city-entry builds.
...
| --- | --- |
| Introduction | Solo chassis or the explicitly listed mite pair. No added supports, recoil, suppression auras or random affixes. Fixed safe opening pattern. |
...
Starter-specific safeguards: Mara's Heat from Shield arrives only on activation; Ivo cannot carry crafted parts between fights; qualifying Bolt support hits return Reactive Mesh damage to Ada; Noor's cooling cannot refresh no-cooldown recipes. Superseded innate shot-damage traits supply no balance credit. Immediate-Utility Shield drafts need reconciliation before they are used as required defence. All existing 606 recipe rows and the approved encounter remain unchanged by this route proposal.
