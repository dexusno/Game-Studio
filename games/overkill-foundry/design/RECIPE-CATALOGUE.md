...
| Shield | Craft and stage in the shield build, then activate the prepared shield when Fire is pressed. Protection stays active through the enemy turn and resets at its end under the existing permanent-upgrade exceptions. Immediate planning-phase activation is superseded. Zero-shot End Turn activation, multiple-shot stacking/replacement, used-part accounting and secondary-effect ordering remain to define. |
