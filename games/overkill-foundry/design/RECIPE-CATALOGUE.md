...
Old Shield clears at enemy-turn end under the default; apply upgrade grants or explicit exceptions at their stated triggers. The earlier recipe-retention allowance/stacking proposal is superseded. **Content reconciliation required:** SH057, SH092, SH113, MA048, MA099, IV019, IV057, IV061, IV090, AD074, AD092 and NO087 cannot be used as written: their recipe-granted retention conflicts with the owner rule. The original draft effect text remains below with a superseded marker so IDs, costs and numbers are not silently retuned. SH034 and SH060 contain older expiry/retention wording; NO060 attempts to convert old Shield after the default reset has already occurred. Immediate Shield grants are reconciled by the 16 September loaded-part rule above. SH026 is now owner-revised to load 4 Shield on recipe Use and a fresh 6-Shield part next round. Explicit future grants of ordinary parts are distinct from active-Shield retention; enemy-phase grant timing remains a separate review item. Saved unused parts follow normal storage; active Shield does not carry by default. Replacement functions and any future upgrade designs remain content work; none is selected by this clarification.
