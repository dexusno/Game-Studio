...
**Remaining draft hit grouping and secondary effects:** the catalogue proposes resolving the summed spread damage as one combined hit per extra target, with stated secondary effects once per different named effect. Under that proposal, kill, Shield-absorption and HP-damage references use that combined hit. The owner has selected addition of the damage contributions, but has not yet selected this grouping or its per-hit defence/recoil consequences; do not treat this paragraph as settled.
