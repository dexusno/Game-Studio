...
All five are proposed scrap ingredients, potentially available from the first city. Circuit should be less common than the bulk materials. The exact haul size and mix still need balancing. Energy cores and credits are not crafting ingredients. The costs in this document are material costs, not shop prices; **owner decision, 15 September: crafting and firing use no separate global energy/action-point budget**. Materials, available parts and recipe use/cooldown requirements provide the action limits. This selects the no-extra-energy rule, not the draft numerical costs, supply amounts or character traits. Explicit recipe-specific resource requirements remain subject to their individual design review. **Owner decision, 15 September:** unused materials and crafted parts have no reserve storage cap within a fight. They carry between rounds and clear at fight end. Recipe memory and assembled bullet/shield part limits are separate; the latter remain open.
