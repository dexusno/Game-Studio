...
| Recipe memory and offers | Starting capacity is 20, subject to balancing after beta testing; choose starter-kit size/composition; duplicate/stronger-version handling; shared or separate use limits/cooldowns; eligible reward recipes and memory replacement | The proposed 12-recipe starter kit is not selected; capacity is 20 and must be distinguished from the number of recipes granted. Duplicates must not accidentally bypass the intended craft limit |
