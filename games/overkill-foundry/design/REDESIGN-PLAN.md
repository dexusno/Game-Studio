...
| Fight boundaries and defeat | Remaining player HP carries between fights; healing routes/tuning and character-meter resets; recipe cooldowns clear at each new fight; loss/retry consequences, and minimal save/continue behaviour | Both unused consumable pools already clear at fight end. HP carryover is selected; healing and campaign stakes remain open; a restart must not silently undo the intended cost of losing |
