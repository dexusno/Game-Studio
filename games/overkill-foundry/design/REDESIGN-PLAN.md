...
**Owner decision, 15 September — Collection persistence:** the active profile keeps its discovered recipe history after death and into subsequent campaigns. Collection history is separate from active campaign recipe memory; new games still use the selected starter set. This decision does not grant retained campaign equipment or select a cross-game unlock rule. **Further owner decision, 15 September:** seeing a recipe offered adds it to Collection even if skipped. The three recipes in a viewed reward offer all count as discoveries; accepting zero or one into campaign memory remains separate. Next question: should all non-starter recipes be eligible to appear from the first campaign under the normal character and rarity restrictions, without permanent unlock requirements?
...
- **World and progression:** the mercenary/AI-robot takeover and fortified-city campaign are now chosen. Character/city identities, total cities, exact bosses, mystery counting, three-choice handling at the boss, final campaign victory, profile unlocks and exact save/Game Over controls remain open. Death ends the current campaign and requires a new game. The five older premises are archived alternatives, not a pending prerequisite.
