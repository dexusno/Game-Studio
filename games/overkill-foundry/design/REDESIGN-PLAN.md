...
**Still open:** post-beta balancing of the initial capacity of 20 and the upgrade increments; duplicate/strength-version memory, use-limit and cooldown behaviour; exact cooldown-counter effects; cooldown handling at fight boundaries; and whether to retain standalone removal.
