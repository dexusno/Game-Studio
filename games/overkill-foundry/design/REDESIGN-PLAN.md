...
**Fight-start reset — owner decision, 15 September:** all recipe cooldown counters start at zero in every new fight. Affordability and ordinary recipe-use rules still apply. Within a fight, cooldown 1 blocks the next round naturally, newly used recipes skip their use-round automatic tick, and explicit cooling may clear counters sooner. This decision does not settle HP recovery or character-meter/helper persistence.
