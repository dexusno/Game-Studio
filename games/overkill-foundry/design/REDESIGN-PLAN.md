...
**Next:** define the Utility part Use action, then what Load activates and the timing of the other non-Ammo parts. Unloading before Fire is confirmed. The separate resource-budget, enemy-roster and economy gaps still need demo values. No gameplay code or new artwork is requested by this flow definition.
