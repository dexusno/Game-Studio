...
Generic grants retain their canonical main-recipe sale basis, even when the upgrade makes them free or changes their damage/Shield amount. Use half the normal one-part ingredient value at current resource prices, rounded down. There is no proportional rescaling by Shield/damage and no automatic zero-sale-price rule. Source recipe discounts and copying also leave that canonical basis intact. Finite supply triggers and the actual shop economy must be tested together.
