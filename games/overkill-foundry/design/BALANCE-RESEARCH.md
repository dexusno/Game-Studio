...
**Inherent-ability update, later 16 September:** the [Quench Recovery proposal](MERCENARY-ABILITIES.md#mara--quench-recovery) lets Mara recover up to 6 actual HP per fight through qualifying Heat payments, at most 2 per player turn. Include its actual use in the 80-HP fixture; do not count the full allowance when the route never spends Heat or heals at full HP. It supplies no automatic victory/city healing. The other mercenaries' proposed traits affect targeting, Bolt repair or Charge rather than directly healing the player.
