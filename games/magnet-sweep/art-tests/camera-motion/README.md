# Magnet Sweep — shared geometry and camera motion study
...
```powershell
& $env:BLENDER_EXE --background --factory-startup --python games/magnet-sweep/art-tests/camera-motion/build_scene.py -- --stills --animate
python games/magnet-sweep/art-tests/camera-motion/encode_review.py
```
