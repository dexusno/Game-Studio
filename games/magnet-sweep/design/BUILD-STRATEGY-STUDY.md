...
**Later owner-defined rules, 13 September 2026:** [the current redesign plan](REDESIGN-PLAN.md#owner-defined-recipe-and-part-system) now specifies character-specific starting weapons/core recipes, one magnet haul per turn, player allocation of source resources to available furnace recipes, crafted ammo/defence/modifier parts, retention of both unused raw resources and unused parts between turns, and a choice of one of three recipe rewards or a skip after each fight. Materials can serve many recipes; the player chooses what to craft now or for later. Recipes and physical parts are distinct. Exact costs, turn ending and cross-fight/profile persistence remain open. This update governs over the earlier direct-component-gathering, multiple-haul and reward suggestions below. The reference study remains useful research; its examples are not implemented or numerically approved.
