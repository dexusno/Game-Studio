...
**Later owner-defined rules, 13 September 2026:** [the current redesign plan](REDESIGN-PLAN.md#owner-defined-recipe-and-part-system) specifies character-specific starting weapons/core recipes, one magnet haul per turn, player-assigned furnace crafting, ammo/defence/modifier parts, and retention of unused raw resources/parts between turns. **Both consumable pools clear at fight end; recipes and permanent weapon upgrades persist through the current game.** Upgrades may grant fresh starting or turn-timed resources/ready parts. Recipe rewards normally offer one of three or a skip. Materials fit many recipes, and the player chooses what to craft now or later. Exact costs, recipe availability, turn ending and new-game/profile persistence remain open. This update governs over earlier direct-component-gathering, multiple-haul and persistence proposals below; research examples are not implemented or numerically approved.
