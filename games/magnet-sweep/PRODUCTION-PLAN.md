...
## Current increment: repair the failed novice experience

Owner playtest supersedes the previous guided-path pass. Acceptance now starts by ignoring the suggested route: collect iron and get paid immediately, mix metals without failure, drag a load onto the furnace or its visible action, and understand carried value versus banked credits. A labelled guard prevents overload/cells before the first bought upgrade. The player sees a 150-credit first-upgrade objective and permanent rig progress. Capture guards end on actual purchase with a visible warning; later protected rescue remains real.

Root owns runtime/HUD/save integration and package; pure lesson state/tests have one separate owner; gameplay critique is read-only; native QA tests the reported stuck route and a separate copy of the owner's save. Success requires those actual results, not merely another prescribed route. Existing payouts/fuel and career are preserved; no new crafting/lore/economy is introduced. Physical owner Escape stopped the current live pass: preserve qa_clarity as possible owner progress. The legacy copy remains prepared but untested.

## Current implementation and acceptance

Clarity 0.4 editor/Windows package and 17 engine automation cases pass, including the nine prior Rework cases. Independent native play confirmed immediate iron-only payout without lesson gates, safe 24 kg training collection and the immediate whole-haul drop response. Physical owner Escape ended the pass; mixed payout, spare-capacity cell exclusion, continuous drag-release, purchase and copied-save continuation remain native gaps in [QA-CLARITY.md](QA-CLARITY.md). The previous T1/T2 guided reward/practice passes and R1/R2 progression/save observations are historical evidence in QA-TUTORIAL.md and QA-REWORK.md; they did not predict the owner's failed novice experience. Presentation assessment and human fun/replay evidence remain distinct work. Exact current artifact and reproduction: [BUILD.md](BUILD.md).

| Work package | Current implementation | Acceptance needed in the actual package |
| --- | --- | --- |
| Physical collection and readable choice | Continuous attraction; combined-mass linked bundles; hold/toggle field and precision controls; stable attachment; 150% capture ceiling | Scrap visibly accelerates and impacts the magnet; group behavior matches visible links; ordinary play and narrow approaches remain readable; toggles, UI boundaries and focus do not produce accidental capture |
