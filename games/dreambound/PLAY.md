...
Current private playtest: **0.5.4-fire4**. Run `scripts/Start-Demo.ps1` or open `BuildOutput/OrganicFireAgility/Windows/Dreambound.exe`. The fire creature has ember-orange eyes; the larger creature has glowing green eyes beneath its recessed lids. Caster travel now frees both arms, shifts the hips and shoulders through each step, lifts and flexes the feet, and turns into its route more readily. Purposeful combat, committed fire throws, the cyborg/weapon and Klaus's fireball sound remain. [Watch the new recorded fight](../../.local/organic-fire-review/caster-agility-delivery.mp4). The recorded route shows the implemented change; ordinary play feedback on naturalness and agility remains open. Previous packages remain available.
