...
Both facial candidates are frozen with the owner-requested `owner-luminous-v1` eye materials and the preserved `status-mask-v2` color correction. Briarhide has green luminous irises; MireSeer has ember-orange luminous irises. The recessed sockets and heavy lids remain intact. Root imported only the existing eye materials and confirmed the colors in actual Editor views: green-eyes-editor-v1 Melee-Detail frames20/40/65 and fire-eyes-editor-v1 Caster-Detail frames15/40/60, under `.local/organic-fire-review`. The caster also reads orange in the side combat view. The same materials are visible in Shipping0.5.4-fire4: caster side frames60/270/427 in fire4-agility-delivery, and larger-creature detail frames20/40 in fire4-green-eyes-delivery. The eye can be occluded by its brow when facing down or away; no owner acceptance is claimed.
