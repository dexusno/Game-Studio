...
$reverieExecutable=Join-Path $reverieGameRoot 'BuildOutput/ReverieUpdate/Windows/Dreambound.exe'
if(-not(Test-Path -LiteralPath $reverieExecutable -PathType Leaf)){
 throw 'The Reverie update package is missing. Build it with scripts/Build.ps1 -Stage All.'
}
