...
$reverieExecutable=Join-Path $reverieGameRoot 'BuildOutput/CreaturePerformance/Windows/Dreambound.exe'
if(-not(Test-Path -LiteralPath $reverieExecutable -PathType Leaf)){
 throw 'The CreaturePerformance package is missing. Build it with scripts/Build.ps1 -Stage All.'
}
