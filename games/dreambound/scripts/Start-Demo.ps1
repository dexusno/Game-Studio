...
$reverieExecutable=Join-Path $reverieGameRoot 'BuildOutput/LivingWorld/Windows/Dreambound.exe'
if(-not(Test-Path -LiteralPath $reverieExecutable -PathType Leaf)){
 throw 'The LivingWorld package is missing. Build it with scripts/Build.ps1 -Stage All.'
}
